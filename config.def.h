...
static const char *power_menu[] = { "power-menu", NULL};

/*Screenshot */
static const char *scr_active[]  = { "grimshot", "save", "active", NULL};
static const char *scr_monitor[] = { "grimshot", "save", "output", NULL};
static const char *scr_area[]    = { "grimshot", "save", "area", NULL};
static const char *scr_area_copy[] = { "grim", "-g", "$(slurp)", "-", "|", "wl-copy", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|SHIFT, 	     XKB_KEY_Up,         movestack,      {.i = +1} },
	{ MODKEY|SHIFT,		     XKB_KEY_Down,       movestack,      {.i = -1} },
	...
	{ MODKEY|SHIFT,              XKB_KEY_Q,          quit,           {0} },
        ...
        { 0,                         XKB_KEY_Print,      spawn,           {.v = scr_active} },
        { MODKEY,                    XKB_KEY_Print,      spawn,           {.v = scr_monitor} },
        { MODKEY|SHIFT,              XKB_KEY_Print,      spawn,           {.v = scr_area} },
        { MODKEY|ALT,                XKB_KEY_Print,      spawn,           {.v = scr_area_copy} },
        { MODKEY|SHIFT,              XKB_KEY_B,          spawn,           {.v = blue} },
	{ MODKEY|SHIFT,              XKB_KEY_T,          spawn,           {.v = torrent} },
        { MODKEY|ALT,                XKB_KEY_Return,     spawn,           {.v = power_menu} },
